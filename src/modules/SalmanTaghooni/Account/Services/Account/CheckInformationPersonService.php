...
class CheckInformationPersonService implements CheckInformationPersonServiceInterface
{
    use HttpRequest;
...
//        return $this->httpPost(Config::get('metabank.BasicInformation'), $this->checkSumWithRequest);
    ...
    {
        return $this->httpPost(Config::get('metabank.CheckInformationPerson'), $this->checkSumWithRequest);
    }

    public function update($request): ?\Psr\Http\Message\ResponseInterface
    {
        return $this->httpPut(Config::get('metabank.CheckInformationPerson'), $this->checkSumWithRequest);
    }
