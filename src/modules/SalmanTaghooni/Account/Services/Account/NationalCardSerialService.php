...
class NationalCardSerialService implements NationalCardSerialInterface
{
    use HttpRequest;
    ...
    {
        return $this->httpGet(Config::get('metabank.NationalCardSerial'), $this->checkSumWithRequest);
    }
    public function store($request): ?\Psr\Http\Message\ResponseInterface
    {
        return $this->httpPost(Config::get('metabank.NationalCardSerial'), $this->checkSumWithRequest);
    }
    public function update($request): ?\Psr\Http\Message\ResponseInterface
    {
        return $this->httpPut(Config::get('metabank.NationalCardSerial'), $this->checkSumWithRequest);
    }
